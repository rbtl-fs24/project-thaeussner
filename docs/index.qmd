...
The question here was "Would you support a campus-wide ban on single-use cups at cafes, kiosks, cafeterias etc?", and the answer could be given on a scale from 1 ("No, absolutely not") to 5 ("Yes, absolutely"). 
